...
namespace Veri_tabanlı_secim_sistemi
{
    public partial class FrmGrafikler : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection(@"Data Source=DESKTOP-7KPL2B4\MSSQLSERVERRRR;Initial Catalog=DBSECİMPROJE ;Integrated Security=True");

        private void FrmGrafikler_Load(object sender, EventArgs e)
        {
            //ilçe adlarını comboboxa çek
            baglanti.Open();
            ...
            //GRAFİĞE toplam sonuçları getirme
            baglanti.Open();
